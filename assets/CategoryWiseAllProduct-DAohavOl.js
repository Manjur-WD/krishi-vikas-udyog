...
`,dt=(e,t)=>{let r=e.includes("top")?1:-1,[i,n]=te()?[nt,ot]:[at(r),it(r)];return{animation:t?`${w(i)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${w(n)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},ut=u.memo(({toast:e,position:t,style:r,children:i})=>{let n=e.height?dt(e.position||t||"top-center",e.visible):{opacity:0},a=u.createElement(rt,{toast:e}),l=u.createElement(ct,{...e.ariaProps},M(e.message,e));return u.createElement(lt,{className:e.className,style:{...n,...r,...e.style}},typeof i=="function"?i({icon:a,message:l}):u.createElement(u.Fragment,null,a,l))});Ae(u.createElement);var pt=({id:e,className:t,style:r,onHeightUpdate:i,children:n})=>{let a=u.useCallback(l=>{if(l){let o=()=>{let c=l.getBoundingClientRect().height;i(e,c)};o(),new MutationObserver(o).observe(l,{subtree:!0,childList:!0,characterData:!0})}},[e,i]);return u.createElement("div",{ref:a,className:t,style:r},n)},mt=(e,t)=>{let r=e.includes("top"),i=r?{top:0}:{bottom:0},n=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:te()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(r?1:-1)}px)`,...i,...n}},ht=T`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,R=16,xt=({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:i,children:n,containerStyle:a,containerClassName:l})=>{let{toasts:o,handlers:c}=He(r);return u.createElement("div",{style:{position:"fixed",zIndex:9999,top:R,left:R,right:R,bottom:R,pointerEvents:"none",...a},className:l,onMouseEnter:c.startPause,onMouseLeave:c.endPause},o.map(d=>{let p=d.position||t,h=c.calculateOffset(d,{reverseOrder:e,gutter:i,defaultPosition:t}),x=mt(p,h);return u.createElement(pt,{id:d.id,key:d.id,onHeightUpdate:c.updateHeight,className:d.visible?ht:"",style:x},d.type==="custom"?M(d.message,d):n?n(d):u.createElement(ut,{toast:d,position:p}))}))},ft=g,Q=new Map,O=new WeakMap,Z=0,gt=void 0;function bt(e){return e?(O.has(e)||(Z+=1,O.set(e,Z.toString())),O.get(e)):"0"}function vt(e){return Object.keys(e).sort().filter(t=>e[t]!==void 0).map(t=>`${t}_${t==="root"?bt(e.root):e[t]}`).toString()}function yt(e){const t=vt(e);let r=Q.get(t);if(!r){const i=new Map;let n;const a=new IntersectionObserver(l=>{l.forEach(o=>{var c;const d=o.isIntersecting&&n.some(p=>o.intersectionRatio>=p);e.trackVisibility&&typeof o.isVisible>"u"&&(o.isVisible=d),(c=i.get(o.target))==null||c.forEach(p=>{p(d,o)})})},e);n=a.thresholds||(Array.isArray(e.threshold)?e.threshold:[e.threshold||0]),r={id:t,observer:a,elements:i},Q.set(t,r)}return r}function jt(e,t,r={},i=gt){if(typeof window.IntersectionObserver>"u"&&i!==void 0){const c=e.getBoundingClientRect();return t(i,{isIntersecting:i,target:e,intersectionRatio:typeof r.threshold=="number"?r.threshold:0,time:0,boundingClientRect:c,intersectionRect:c,rootBounds:c}),()=>{}}const{id:n,observer:a,elements:l}=yt(r),o=l.get(e)||[];return l.has(e)||l.set(e,o),o.push(t),a.observe(e),function(){o.splice(o.indexOf(t),1),o.length===0&&(l.delete(e),a.unobserve(e)),l.size===0&&(a.disconnect(),Q.delete(n))}}function wt({threshold:e,delay:t,trackVisibility:r,rootMargin:i,root:n,triggerOnce:a,skip:l,initialInView:o,fallbackInView:c,onChange:d}={}){var p;const[h,x]=u.useState(null),f=u.useRef(),[b,E]=u.useState({inView:!!o,entry:void 0});f.current=d,u.useEffect(()=>{if(l||!h)return;let y;return y=jt(h,(F,S)=>{E({inView:F,entry:S}),f.current&&f.current(F,S),S.isIntersecting&&a&&y&&(y(),y=void 0)},{root:n,rootMargin:i,threshold:e,trackVisibility:r,delay:t},c),()=>{y&&y()}},[Array.isArray(e)?e.toString():e,h,n,i,a,l,r,c,t]);const C=(p=b.entry)==null?void 0:p.target,D=u.useRef();!h&&C&&!a&&!l&&D.current!==C&&(D.current=C,E({inView:!!o,entry:void 0}));const v=[x,b.inView,b.entry];return v.ref=v[0],v.inView=v[1],v.entry=v[2],v}const Nt=new Array(6).fill(!0),Et=()=>{var Y;const{category:e,type:t}=J(),[r,i]=u.useState(0),[n,a]=u.useState(""),[l,o]=u.useState(0),[c,d]=u.useState(12),{data:p,hasNextPage:h,fetchNextPage:x,isFetchingNextPage:f,isLoading:b,isError:E,error:C}=je({queryKey:["category-wise-all-product",r,n,l,c],queryFn:({pageParam:N})=>oe(r,n,N*c,c),getNextPageParam:(N,m)=>N&&N.length===12?m.length+1:void 0,initialPageParam:0}),{filterBtnState:D,setFilterBtnState:v}=u.useContext(K),[y,F]=u.useState(!1),S=()=>{F(!y)},{ref:se,inView:V}=wt({threshold:0});return u.useEffect(()=>{V&&(h?x():ft.success("All products are loaded!",{duration:5e3}))},[V,h]),u.useEffect(()=>{e==="tractor"?(i(1),a(t)):e==="goods-vehicle"?(i(3),a(t)):e==="harvester"?(i(4),a(t)):e==="implements"?(i(5),a(t)):e==="tyre"?(i(7),a(t)):e==="agri-inputs"&&(t==="seeds"&&i(6),t==="pesticides"&&i(8),t==="fertilizer"&&i(9))},[e,t]),s.jsxs(s.Fragment,{children:[s.jsx(pe,{}),s.jsx(me,{}),s.jsx(Ne,{}),s.jsx(xt,{}),s.jsx("section",{className:"mobile-filter-and-sort-btn lg:hidden block bg-lightgreen sticky md:top-[147px] top-[62px] z-10",children:s.jsxs("div",{className:"container px-10  grid grid-cols-2",children:[s.jsxs("button",{type:"button",className:"sort-btn text-lg text-white border-r border-white h-full py-2",onClick:()=>v(!0),children:[s.jsx(he,{className:"inline mb-1"})," Filter"]}),s.jsxs("button",{type:"button",className:"sort-btn text-lg text-white",onClick:S,children:[s.jsx(xe,{className:"inline mb-1"})," Sort"]})]})}),s.jsxs("main",{className:"products-container-wrapper container bg-whitesmoke md:px-10 ",children:[s.jsx(ke,{}),s.jsx(Pe,{sort_btn_state:y}),s.jsx("section",{className:"category-wise-all-product",children:b?s.jsx("div",{className:"product-skeleton grid md:grid-cols-3 2xl:grid-cols-4 grid-cols-2 px-5 gap-x-4",children:Nt.map((N,m)=>s.jsx(ve,{},m))}):s.jsxs("div",{className:"product-list-container mb-5",children:[s.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 md:px-5  px-2 md:gap-x-4 gap-x-2",children:(Y=p==null?void 0:p.pages)==null?void 0:Y.map(N=>N&&N.map(m=>s.jsx(ie,{to:`${fe}/${e}/${t}/${m.id}`,children:s.jsx(ge,{product_full_details:m,product_image:m.front_image?m.front_image:m.image1,product_title:`${m.brand_name} ${m.model_name}`=="Others Others"||`${m.brand_name} ${m.model_name}`=="undefined undefined"||`${m.brand_name} ${m.model_name}`=="null null"?m.title:`${m.brand_name} ${m.model_name}`,product_location:m.district_name,product_pricing:m.price,distance_product:m.distance,rent_type:t==="rent"&&m.rent_type?` / ${m.rent_type.slice(4)}`:""})},m.id)))}),h?s.jsxs("div",{ref:se,className:"lod-more-product flex items-center gap-2 justify-center w-full mt-5",children:[s.jsxs("div",{className:"relative",children:[s.jsx("span",{className:"loader"}),s.jsx("img",{src:ne,alt:"this is a icon of preloader",className:"absolute top-[49.5%] left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-lg"})]}),s.jsx("span",{className:"text-darkGreen text-2xl",children:"Loading More"})]}):null]})})]}),s.jsx(be,{})]})};export{Et as default};
